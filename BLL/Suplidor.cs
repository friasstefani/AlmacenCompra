...
namespace BLL
{
    public class Suplidor
    {
        ...
        {
            return conectar.EjecutarDB(" update Suplidores set Nombre ='" + Nombre + "',Telefono ='" + Telefono + "',Celular ='" + Celular + "',Direcion ='" + Direcion + "',Email ='" + Email + "' where CodigoSuplidor = '" + CodigoSuplidor + "' ");
        }
